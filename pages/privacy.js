...
export default function Privacy() { 
  return (
    <div>
      <Head>
        <link rel="canonical" href="https://findmoremaps.com/privacy" />

        <title>Privacy - Find More Maps</title>
        ...
        <meta name="twitter:title" content="Privacy - Find More Maps" />
        ...
        <meta property="twitter:url" content={`https://findmoremaps.com/privacy`}/>

        <meta property="og:title" content="Privacy - Find More Maps" />
        ...
        <meta property="og:url" content={`https://findmoremaps.com/privacy`}/>
          ...
          <Box width="100%" padding="1rem 0" bg={'#f0f5f9'}>
            <Container maxW={'5xl'}>
              <Stack
                ...
                At Find More Maps, we put our users first. To keep you in the know, here is our privacy policy - detailing the data we collect and how we use it. 🔒
                </Text>
              </Stack>
            </Container>
          </Box>
          <Container pt={5} maxW={'1500px'}>
          <Text color={'gray.600'} fontSize={"lg"}>At Find More Maps, accessible from findmoremaps.com, one of our main priorities is the privacy of our visitors. This privacy policy document contains types of information that is collected and recorded by Find More Maps and how we use it.</Text><br />
...
<Text color={'gray.600'} fontSize={"lg"}>This privacy policy applies only to our online activities and is valid for visitors to our website with regards to the information that they shared and/or collect in Find More Maps. This policy is not applicable to any information collected offline or via channels other than this website.</Text><br />
...
<Text color={'gray.600'} fontSize={"lg"}>Like any other website, Find More Maps uses &apos;cookies&apos;. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.</Text><br />
...
<Text color={'gray.600'} fontSize={"lg"}>Find More Maps&apos;s privacy policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options. </Text><br />
